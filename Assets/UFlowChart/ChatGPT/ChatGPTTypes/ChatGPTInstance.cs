...
namespace ZKnight.UFlowChart.ChatGPT
{
    public class ChatGPTInstance
    {
        ...
        public ChatGPTInstance(string apiKey = DefaultAPIKey, string userId = DefaultUserId, string model = DefaultModel, float temperature = DefaultTemperature)
        {
        ...
        public void RestoreChatHistory()
        {
            ...
            {
                var jsonObj = JsonConvert.DeserializeObject<List<Message>>(chatHistoryJson);
                if (jsonObj != null)
                {
